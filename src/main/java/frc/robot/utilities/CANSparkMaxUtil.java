...
public class CANSparkMaxUtil {
    ...
    public static void setSparkMaxBusUsage(CANSparkMax motor, Usage usage, boolean enableFollowing) {
        if (enableFollowing) {
    ...
    public static void setSparkMaxBusUsage(CANSparkMax motor, Usage usage) {
